...
def ListarClientesPage():
    ...
    for i, row in df_clientes.iterrows():
        ...
        col2.button("Excluir", key=f"excluir_{row['ID']}", on_click=excluir_cliente, args=(row["ID"],), kwargs={}, help="Remove o cliente da sua tabela e atualiza a lista automaticamente")
